    ...
    <section class="section pt-0 px-0" >
      <div class="container is-mobile " style="max-width: 810px">
        <div class="content has-text-left px-5">
          <p>Welkom bij de <b>jaarlijkse vlaaienslag</b> van Scouts Hellegat! Op 9 oktober 2021 zal onze actie opnieuw plaatsvinden. Je kan hier je bestelling doorgeven & betalen. Woon je in Niel? dan komen we ook langs aan de deur!</p>
          

          <p>Leveren tussen 10u en 13u is mogelijk in
